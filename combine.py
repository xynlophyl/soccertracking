...
def combine_videos(clip_video_path, minimap_video_path, output_path, minimap_size=(300, 400)):
    # Open the clip video
...
if __name__ == "__main__":
    ...
    combine_videos(clip_video_path, minimap_video_path, output_path, minimap_size)
