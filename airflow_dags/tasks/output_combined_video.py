...
if __name__ == "__main__":
    ...
    try:
        ...
        clip_video_path = f"{GCP_PROJECT_PATH}/outputs/{filename}/output_annotated_{filename}.avi"  # Path to the first video
        minimap_video_path = f"{GCP_PROJECT_PATH}/outputs/{filename}/output_minimap_{filename}.avi"  # Path to the second video
        output_path = f"{GCP_PROJECT_PATH}/outputs/{filename}/output_combined_{filename}.avi"  # Path to save the combined video
